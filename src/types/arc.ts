...
export const GENERIC_REQUISITIONS: RequisitionEntry[] = [
  {
    name: '常规手提箱',
    effect: '这个毫无趣味、平平无奇的手提箱能够捕获并安全收容任何大小的异常体。\n\n要让普通手提箱生效，异常体必须筋疲力尽、被安抚，或是自愿的。\n\n小贴士：通常，成功收容异常的关键在于识别其焦点——即导致其诞生的核心思想或情感。',
    code: 'N/a',
  },
  {
    name: '波纹枪',
    effect: '此武器原本是1970年代某美国科幻电视剧的道具，目前已被证实为唯一能够直接干扰异常共振的装置。\n\n该武器仅能储存一发能量，只要「波纹枪」能够直接无障碍物阻挡的瞄准一个目标异常，便可释放能量对其进行永久性中和。\n\n注意事项：\n「波纹枪」内置安全机制，无法对共鸣体进行射击。确保自身绝不处于「波纹枪」与目标之间，以免不可预测的后果。\n\n出于中和任务目标以外的任何目的发射波纹枪，将被记3次申诫。',
    code: 'N/a',
  },
];
